...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(40, 30, 261, 51))
        self.label.setObjectName("label")
        self.radioButtonFirstClass = QtWidgets.QRadioButton(Dialog)
        self.radioButtonFirstClass.setGeometry(QtCore.QRect(30, 110, 141, 21))
        ...
        self.radioButtonBusinessClass.setGeometry(QtCore.QRect(30, 140, 161, 21))
        ...
        self.radioButtonEconomyClass.setGeometry(QtCore.QRect(30, 170, 151, 21))
        self.radioButtonEconomyClass.setObjectName("radioButtonEconomyClass")
        self.labelFare = QtWidgets.QLabel(Dialog)
        self.labelFare.setGeometry(QtCore.QRect(30, 230, 301, 41))
