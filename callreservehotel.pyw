...
class MyForm(QDialog):
    def __init__(self):
        ...
        self.setStyleSheet(PyQt5_stylesheets.load_stylesheet_pyqt5(style="style_navy"))
    ...
    def computeRoomRent(self):
        ...
        datainserting = str(dateselected.toPyDate())
        noOfDays = self.ui.spinBox.value()
        chosenRoomType = self.ui.comboBox.itemText(self.ui.comboBox.currentIndex())
        self.ui.Enteredinfo.setText('Date of reservation: '+datainserting+ ', Number of days: ' +str(noOfDays) + ' and Room type selected: ' +chosenRoomType)
        roomRent = 0
